...
# remove symbols from dictionnary check
def encryptcompat():
    global eTextGlobal
    eTextGlobal = ""
...
# Widgets
Title = tk.Label(master, text="This is the ceasar cypher encryptor:\n", bg="#00bae9", font=("Courier", 10))
...
Title2 = tk.Label(master, text="This is the ceasar cypher decryptor:\n", bg="#00bae9", font=("Courier", 10))
