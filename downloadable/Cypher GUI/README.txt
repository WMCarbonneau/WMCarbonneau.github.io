...
The linux .sh file should work though you may need to make it executable on your system.
The cypher outputs to the console as a bonus, as well as to the GUI.
The output of the cypher can be saved to the text files that the program creates.
...
This program uses string, collections and tkinter as imports